...
phases_status:
  ...
  "16-19": outline depth; each needs its own grilling pass before implementation
last_grilled_phase: 15
last_grilled_date: 2026-08-28
---
...
**Status: Grilled 2026-08-28 (I1..I30 + F15-1..F15-15). Ready for sub-plan via `create-plan`. Not yet implemented.**

Single sub-plan will ship at `thoughts/shared/plans/2026-08-28-ifrs17-pack.md` built via `create-plan` → `implement-plan`. Aggregate success criteria across all phases:
