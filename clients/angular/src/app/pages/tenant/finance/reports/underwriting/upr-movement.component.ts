...
import {
  UprMovementParams,
  UprMovementReportService,
  UprMovementRow,
} from '../../../../../core/services/upr-movement-report.service';
...
export class UprMovementReportComponent implements OnInit {
  ...
  get activeRows(): UprMovementRow[] {
    return this.envelope?.data ?? [];
  }

  private buildParams(): UprMovementParams {
    return {
  ...
  private filename(): string {
    const parts = ['upr-movement', `${this.periodStart}_${this.periodEnd}`];
