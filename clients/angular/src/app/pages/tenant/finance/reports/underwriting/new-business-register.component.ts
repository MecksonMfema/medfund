...
import {
  NewBusinessRegisterParams,
  NewBusinessRegisterReportService,
  NewBusinessRegisterRow,
} from '../../../../../core/services/new-business-register-report.service';
...
export class NewBusinessRegisterReportComponent implements OnInit {
  ...
  get activeRows(): NewBusinessRegisterRow[] {
    return this.envelope?.data ?? [];
  }

  private buildParams(): NewBusinessRegisterParams {
    return {
  ...
  private filename(): string {
    const parts = ['new-business-register', `${this.periodStart}_${this.periodEnd}`];
