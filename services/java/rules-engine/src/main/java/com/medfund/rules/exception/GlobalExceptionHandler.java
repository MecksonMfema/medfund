package com.medfund.rules.exception;
...
/**
 * Mirrors the exception-handling shape of every other Java service so
 * unhandled errors never leak class names or stack traces. See
 * {@code GlobalExceptionHandler} in user-service / claims-service / etc.
...
public class GlobalExceptionHandler {
    ...
    public Mono<ProblemDetail> handleNotFound(NoSuchElementException ex) {
