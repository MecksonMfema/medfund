...
public class GroupCensusAdapter implements ScheduledReportShapeAdapter {

    private static final String PATH = "/api/v1/reports/GROUP_CENSUS/scheduled-render";
    ...
    @Override public ReportKey key() { return ReportKey.GROUP_CENSUS; }
    ...
    public Mono<byte[]> render(ScheduledFireContext ctx) {
        return helper.render(ctx, userBaseUrl, PATH, "user.group-census.render");
    }
}
