...
public class PersistencyCohortAdapter implements ScheduledReportShapeAdapter {

    private static final String PATH = "/api/v1/reports/PERSISTENCY_COHORT/scheduled-render";
    ...
    @Override public ReportKey key() { return ReportKey.PERSISTENCY_COHORT; }
    ...
    public Mono<byte[]> render(ScheduledFireContext ctx) {
        return helper.render(ctx, userBaseUrl, PATH, "user.persistency-cohort.render");
    }
}
