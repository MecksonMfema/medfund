...
/**
 * Inline response for the NAIC Schedule F submit endpoint. Callers poll
 * the shared {@code /api/v1/reports/jobs/{jobId}} endpoint for the
 * terminal state and download the XLSX via
 * {@code /api/v1/reports/regulatory/naic/schedule-f/jobs/{jobId}/xlsx}
 ...
 */
public record NaicScheduleFJobSubmissionResponse(UUID jobId, String status, boolean deduplicated) {}
