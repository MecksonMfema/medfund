 ...
 * used by {@code contributions-service.PageResponse} and
 * {@code claims-service.PageResponse} so the Angular {@code <app-data-table>}
 * component can consume finance-service pages without a second envelope
 * adapter.
 */
