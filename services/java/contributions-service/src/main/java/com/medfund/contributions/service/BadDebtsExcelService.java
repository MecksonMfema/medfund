...
public class BadDebtsExcelService {
    ...
    public Mono<byte[]> generate(String currency, String subjectType, String q) {
        return balanceService.listBadDebts(currency, subjectType, q, 0, MAX_ROWS)
    ...
    private byte[] render(PageResponse<CreditorRow> page, String currency,
        ...
        try (Workbook wb = new XSSFWorkbook(); ByteArrayOutputStream out = new ByteArrayOutputStream()) {
            ...
            cell(titleRow, 0, "Bad debts", title);
            ...
            throw new RuntimeException("Failed to build bad-debts workbook", e);
        }
    }
